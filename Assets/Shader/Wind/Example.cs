...
public class Example : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        buttonPos1 = new Rect(10.0f, 10.0f, 500.0f, 70.0f);
        buttonPos2 = new Rect(10.0f, 100.0f, 500.0f, 70.0f);
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(buttonPos1, "Draw Debug", customButton))
            DrawDebug();
        //Press this Button to edit the vertices obtained from the Sprite
        if (GUI.Button(buttonPos2, "Perform OverrideGeometry", customButton))
            ChangeSprite();
    }
